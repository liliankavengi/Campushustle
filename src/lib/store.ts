...
const LIVE_UPCOMING_TASKS: Omit<Gig, 'id' | 'createdAt' | 'applicantCount'>[] = [
  ...
  {
    posterName: 'Scale AI / Outlier Partner',
    title: 'Kenyan Sheng & Dialect Dialogue Consistency Benchmarking',
    description: 'Review generative AI dialogue transcripts for authentic Kenyan street syntax, regional vocabulary, and contextual nuances. Weekly payout direct to M-Pesa.',
    category: 'AI Annotation',
    rewardKes: 15500,
    escrowStatus: 'HELD',
    originType: 'EXTERNAL_PARTNER',
    externalApplyUrl: 'https://outlier.ai/evaluators',
    campus: 'ALL',
  ...
  },
  {
    ...
    title: 'Legal & Constitutional Law AI Reasoning Evaluation Batch',
    description: 'Evaluate Kenyan constitutional court case summaries generated by legal LLMs for statutory precision and legal precedent citation accuracy.',
    category: 'AI Annotation',
    rewardKes: 22000,
    escrowStatus: 'HELD',
    originType: 'EXTERNAL_PARTNER',
    externalApplyUrl: 'https://alignerr.com/legal-tasks',
    campus: 'ALL',
    deviceRequirement: 'LAPTOP_REQUIRED',
    skills: ['Law', 'Constitutional Law', 'Fact Checking'],
    platformName: 'Alignerr',
    qualificationGuide: 'Requires basic legal knowledge test. Payout $18/hr.',
  },
  {
    posterName: 'Brian Kibet (Strathmore Law)',
    title: 'Commercial Law Moot Court Case Brief & Skeleton Arguments',
    description: 'Assist in drafting 8-page skeleton argument for regional university arbitration moot court competition.',
    category: 'Campus Task',
    rewardKes: 3500,
    escrowStatus: 'HELD',
    originType: 'INTERNAL_ESCROW',
    campus: 'Strathmore',
    deviceRequirement: 'LAPTOP_REQUIRED',
    skills: ['Legal Drafting', 'Moot Court', 'Research'],
    deadline: 'In 4 days',
  },
  {
    posterName: 'Faith Jepkosgei (Egerton Njoro)',
    title: 'Agribusiness Field Survey Data Entry & Excel Pivot Charts',
    description: 'Enter 180 handwritten dairy farmer survey sheets into structured Excel tables and generate automated pivot charts for cooperative presentation.',
    category: 'Campus Task',
    rewardKes: 1750,
    escrowStatus: 'HELD',
    originType: 'INTERNAL_ESCROW',
    campus: 'Egerton',
    deviceRequirement: 'SMARTPHONE_OK',
    skills: ['Excel', 'Pivot Tables', 'Data Entry'],
    deadline: 'This weekend',
  },
  {
    posterName: 'Dennis Barasa (Moi Eldoret)',
    title: 'Graphic Design for Campus Tech Week Posters & Badges',
    description: 'Design 3 high-resolution vector flyers and 5 social media banner templates in Figma or Canva for annual student tech symposium.',
    category: 'Tech & Design',
    rewardKes: 2200,
    escrowStatus: 'HELD',
    originType: 'INTERNAL_ESCROW',
    campus: 'Moi',
    deviceRequirement: 'SMARTPHONE_OK',
    skills: ['Figma', 'Canva', 'Poster Design'],
